...
* **prompt:** stream NDJSON events with --json, add --no-stream for batch output (#143)
...
* **release:** enable macOS Keychain access for release binaries (#141)
* **tunnel:** add project support to terminal tool (#139)
...
* **tui:** add persistent input history with Up/Down navigation (#132)
* **tui:** dynamic input height and user message wrapping (#124)
* **tui:** message queuing and steering during streaming (#121)


### Bug Fixes

* **deps:** update module github.com/stretchr/testify to v1.11.1 (#131)
...
* **ci:** use go-to-wheel fork with --package-path support (#117)
